...
<div class="ui center aligned segment" id="content_segment">
	<div id="lightgallery">
	  <a href="<?php echo base_url() ?>assets/img/kcafe.jpg">
	      <img src="<?php echo base_url() ?>assets/img/kcafe.jpg" style="width:300px;height:auto" />
	  </a>
	  <a href="<?php echo base_url() ?>assets/img/kcafe2.jpg">
	  		<img  src="<?php echo base_url() ?>assets/img/kcafe2.jpg" style="width:300px;height:auto" />
	  </a>
	  <a href="<?php echo base_url() ?>assets/img/kcafe3.jpg">
	  		<img  src="<?php echo base_url() ?>assets/img/kcafe3.jpg" style="width:300px;height:auto" />
	  </a>
	  <a href="<?php echo base_url() ?>assets/img/kcafe4.jpg">
	  		<img  src="<?php echo base_url() ?>assets/img/kcafe4.jpg" style="width:300px;height:auto" />
	  </a>
