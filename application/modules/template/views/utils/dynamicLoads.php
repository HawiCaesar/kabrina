	...
	*/
	...
	if(is_array($css_plugin_files)){
		foreach($css_plugin_files as $file){
			echo "<".$cssTag." rel='stylesheet' href='".base_url()."assets/bower_components/".$file."'".$cssTagType."></".$cssTag.">\n";
		}
	}
	if(is_array($js_plugin_files)){
		foreach($js_plugin_files as $file){
			echo "<".$jsTag." src='".base_url()."assets/bower_components/".$file."'".$jsTagType."></".$jsTag.">\n";
		}
	}
